<x-app-layout>
    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="mt-6 bg-white divide-y rounded-lg shadow-sm dark:bg-gray-800 dark:divide-gray-900">
                @foreach ($chirps as $chirp)
                    <div class="flex p-6 space-x-2">
                        <svg class="w-6 h-6 text-gray-600 dark:text-gray-400 -scale-x-100" fill="none"
